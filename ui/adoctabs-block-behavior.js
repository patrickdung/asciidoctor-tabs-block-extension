...
var tabOnSmallScreen = 1 // display tab on mobile view below (768px,see below) screen
//var smallBreak = 768 // Your small screen breakpoint in pixels
var smallBreak = 540 // Your small screen breakpoint in pixels
find('.tabset').forEach(function (tabset) {
  var active
  var tabs = tabset.querySelector('.adoctabs')
  if (tabs) {
    var first
          ...
          checkActiveClass = setTimeout(function () {
            ...
            if (activeTabList) {
              if (queueData.length > 0) {
                ...
                var dropdownMenu = tab.parentNode.parentNode.querySelector('.adoctabs .other-tablist')
...
function activateTab (e) {
  ...
  var tabMenu = document.querySelector('.adoctabs ul')
  var nodeTab = tab.parentNode.parentNode.parentNode.querySelector('.adoctabs > ul')
  ...
  // for tab active pane
  find('.adoctabs li, .tab-pane', this.tabset).forEach(function (it) {
